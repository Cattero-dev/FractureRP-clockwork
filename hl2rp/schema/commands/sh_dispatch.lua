...
function COMMAND:OnRun(player, arguments)
	if (Schema:PlayerIsCombine(player)) then
		...
		local rankName = Schema:GetCombineRank(player:GetName());

		if (faction == FACTION_SCANNER or faction == FACTION_OTA or faction == FACTION_MPF and (Schema:GetCombineRank(player:Name()) == "DvL" or Schema:GetCombineRank(player:Name()) == "SeC")) then
