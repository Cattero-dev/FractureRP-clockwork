...
Clockwork.config:Add("use_smooth_rates", false, nil, nil, nil, nil, true);
...
Clockwork.config:Add("default_inv_space", 10, true);
Clockwork.config:Add("custom_weapon_color", true);
Clockwork.config:Add("save_data_interval", 60);
...
Clockwork.config:Add("scale_prop_cost", 0);
...
Clockwork.config:Add("ooc_interval", 30);
...
Clockwork.config:Add("player_should_smooth_sprint", false);
