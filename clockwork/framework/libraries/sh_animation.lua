...
Clockwork.animation:AddCombineOverwatchModel("models/male_frp_elite_combine.mdl");
Clockwork.animation:AddFemaleHumanModel("models/female_frp_elite_combine.mdl");
